...
public struct NamiTheme: ThemeProtocol {
    ...
    public var primaryActionButtonStyle: any ButtonStyle {
        NamiActionButtonStyle(rank: .primary)
    }
    public var secondaryActionButtonStyle: any ButtonStyle {
        NamiActionButtonStyle(rank: .secondary)
    }
    public var tertiaryActionButtonStyle: any ButtonStyle {
        NamiActionButtonStyle(rank: .tertiary)
    }
    public var destructiveActionButtonStyle: any ButtonStyle {
        NamiActionButtonStyle(rank: .destructive)
    }
}
